...
?>
    ...
    <section class="header-section flex-column-center header-overlay" style="background-image: url('./img/juaninos_04.jpg');background-position: center bottom;">
    ...
    <div id="wrapper" class="wrapper parallax">
        ...
        <section id="historia" class="historia">
            ...
            <!-- Slider Alimentos -->
            <div class="gallery-azotea mb-80">
            ...
            <div class="container">
                ...
                <div class="row flex-row-center mb-80">
                    <div class="col-sm-4 no-padding">
                        <img src="./img/team/chef.jpg" alt="" class="img-responsive border-gray-soften">
                    </div>
                    <div class="col-sm-4 border-gray-soften padding-card bio-info ml-30n bg-white">
